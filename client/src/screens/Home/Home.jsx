    ...
    return (
        <div className="home">
            ...
            <section className="section-3">
                ...
                <p>Prepare to be swept away as you put your best foot forward in this epic celebration of creativity and culture that promises you laughter, joy and memories that will last you a lifetime and more.</p>
            </section>
            <section className="section-4">
                <Heading title={"ARTISTS"} />
                {/* <Marquee images={artists.map((artist) => `/assets/imgs/artists/${artist.img}`)} /> */}
            </section>
